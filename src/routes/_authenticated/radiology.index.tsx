                ...
                return (
                  <tr key={o.id} className="border-b border-border last:border-0 hover:bg-accent/30">
                    <td className="px-5 py-2.5">
                      <Link to="/radiology/studies/$id" params={{ id: o.id }} className="font-mono text-[11px] text-primary hover:underline">
                        {o.orderNo}
                      </Link>
                    </td>
                    <td className="px-5 py-2.5">
            ...
            {critical.map((r) => {
              ...
              return (
                <li key={r.id} className="px-5 py-3">
                  <Link to="/radiology/studies/$id/report" params={{ id: order.id }} className="block">
